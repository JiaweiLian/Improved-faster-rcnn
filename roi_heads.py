...
#         pt    = torch.exp(logpt)
# 
#         focal_loss = -2 * ((1 - pt) ** self.focusing_param) * logpt
# 
...
def fastrcnn_loss(class_logits, box_regression, labels, regression_targets):
    ...
    # classification_loss = F.cross_entropy(class_logits, labels)  # orginal
    ########################################################################
    loss = FocalLoss()
    classification_loss = loss(class_logits, labels)  # changed
    ########################################################################
